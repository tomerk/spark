...
import org.apache.spark.bandit.{BanditManager, BanditManagerMaster, BanditManagerMasterEndpoint}
...
class SparkEnv (
    ...
    val banditManager: BanditManager,
...
object SparkEnv extends Logging {
  ...
  private def create(
    ...
    val banditManager = new BanditManager(
      isDriver,
      executorId,
      conf,
